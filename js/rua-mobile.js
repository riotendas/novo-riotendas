    ...
    return `
      ...
      <article class="rua-mobile-card tipo-${String(rota.tipo || "").toLowerCase()} ${classeConclusao}" data-rua-card-id="${rota.id}">
        ...
        ${concluida && !expandido ? "" : `<div class="rua-mobile-acoes rua-mobile-acoes-compactas">
          ...
          ${tel ? `<button type="button" class="btn-outline rua-mobile-acao-btn rua-mobile-whatsapp-api-btn" data-rota-whatsapp="${ruaMobileEscAttr(rota.id)}" title="Comunicações" aria-label="Abrir comunicações"><span><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5.75A2.75 2.75 0 0 1 6.75 3h10.5A2.75 2.75 0 0 1 20 5.75v7.5A2.75 2.75 0 0 1 17.25 16H10l-4.6 3.45A.9.9 0 0 1 4 18.73V5.75Z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M8 8.5h8M8 11.5h5.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg></span><small>Msg</small></button>` : ""}
